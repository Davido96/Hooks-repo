...
silent only
silent tabonly
cd ~/Desktop/codes/webapps/hooks/documentation
...
setlocal statusline=%#lualine_a_insert#\ INSERT\ %#lualine_transitional_lualine_a_insert_to_lualine_c_filetype_MiniIconsYellow_insert#%<%#lualine_c_filetype_MiniIconsYellow_insert#\ 󰌠\ %#lualine_c_normal#%#lualine_c_normal#%#lualine_c_8_LV_Bold_insert#\ urls.py%#lualine_c_normal#\ %#lualine_c_normal#%=%#lualine_x_13_insert#\ a\ %#lualine_c_normal#%#lualine_x_14_insert#\ --\ INSERT\ --\ %#lualine_c_normal#%#lualine_x_16_insert#\ \ 21\ %#lualine_transitional_lualine_b_insert_to_lualine_x_16_insert#%#lualine_b_insert#\ 83%%\ %#lualine_b_insert#\ \ 5:57\ %#lualine_transitional_lualine_a_insert_to_lualine_b_insert#%#lualine_a_insert#\ \ 15:43\ 
