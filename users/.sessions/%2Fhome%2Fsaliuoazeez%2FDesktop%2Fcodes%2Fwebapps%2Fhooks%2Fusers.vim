...
setlocal statusline=%#lualine_a_normal#\ NORMAL\ %#lualine_transitional_lualine_a_normal_to_lualine_c_filetype_MiniIconsYellow_normal#%<%#lualine_c_filetype_MiniIconsYellow_normal#\ 󰌠\ %#lualine_c_normal#%#lualine_c_normal#%#lualine_c_8_LV_Bold_normal#\ serializers.py%#lualine_c_normal#\ %#lualine_c_normal#%=%#lualine_x_16_normal#\ \ 21\ %#lualine_transitional_lualine_b_normal_to_lualine_x_16_normal#%#lualine_b_normal#\ 78%%\ %#lualine_b_normal#\ 58:1\ \ %#lualine_transitional_lualine_a_normal_to_lualine_b_normal#%#lualine_a_normal#\ \ 04:29\ 
...
38
sil! normal! zo
let s:l = 46 - ((14 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 46
...
setlocal spelloptions=noplainbuffer
setlocal statuscolumn=%!v:lua.require'snacks.statuscolumn'.get()
setlocal statusline=%#lualine_a_normal#\ NORMAL\ %#lualine_transitional_lualine_a_normal_to_lualine_c_diagnostics_error_normal#%<%#lualine_c_diagnostics_error_normal#\ \ 3\ %#lualine_c_normal#%#lualine_c_filetype_MiniIconsYellow_normal#\ 󰌠\ %#lualine_c_normal#%#lualine_c_normal#%#lualine_c_8_LV_Bold_normal#\ serializers.py%#lualine_c_normal#\ %#lualine_c_normal#%=%#lualine_x_16_normal#\ \ 21\ %#lualine_transitional_lualine_b_normal_to_lualine_x_16_normal#%#lualine_b_normal#\ 78%%\ %#lualine_b_normal#\ 58:1\ \ %#lualine_transitional_lualine_a_normal_to_lualine_b_normal#%#lualine_a_normal#\ \ 16:48\ 
setlocal suffixesadd=.py
setlocal swapfile
setlocal synmaxcol=3000
if &syntax != ''
...
67
sil! normal! zo
let s:l = 58 - ((13 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 58
